<%-- 
    Document   : editar
    Created on : 28/11/2023, 7:49:29 p. m.
    Author     : USER
--%>
...
<html lang="en">
    ...
    <body>
                ...
                <ul>
                    ...
                    <li>
                        <a href="gestionUsuarios.jsp">
                            ...
                            <span class="titulo">Gestión Usuarios</span>
                        </a>
                    </li>
                    <li>
        ...
        <script src="../../JSS/consultaeditar.js" type="text/javascript"></script>
        <script src="../../JSS/all.js" type="text/javascript"></script>
        <script src="../../JSS/updates.js" type="text/javascript"></script>
    </body>
</html>
